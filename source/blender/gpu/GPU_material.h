...
typedef enum GPUDynamicType {
	...
	GPU_DYNAMIC_LAMP_DYNAREAMAT      = 8  | GPU_DYNAMIC_GROUP_LAMP,
	...
	GPU_DYNAMIC_LAMP_DYNAREASCALEX	 = 17 | GPU_DYNAMIC_GROUP_LAMP,
	GPU_DYNAMIC_LAMP_DYNAREASCALEY	 = 18 | GPU_DYNAMIC_GROUP_LAMP,
