...
static PyObject *PyInit_gpu(void)
{
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_LAMP_DYNAREASCALEY);
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_LAMP_DYNAREASCALEX);
	...
	PY_MODULE_ADD_CONSTANT(m, GPU_DYNAMIC_LAMP_DYNAREAMAT);
